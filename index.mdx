...
import WideTile1 from './components/WideTile';
...
<Box my={25}>
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    <ThinTile to="https://docs.ripple.com/custody" icon={icon1} header="Rock">
  ...
  <FlexSection justifyContent="space-around" flexWrap="wrap">
    ...
    <WideTile to="https://helloredo.redoc.ly/alexdocs" header="Paper">
        Lorem ipsum dolor sit amet, pri putent oportere quaerendum in, ea mea justo invenire
        aliquando. Usu modo suavitate ea. Et sed labitur epicurei adipiscing. Nibh zril labitur
        an usu.
    </WideTile>
  ...
  title="Sample Title"
  description="This is a sample description for the wide tile component."
  link="https://helloredo.redoc.ly/alexdocs">
 </WideTile1>
  </FlexSection>
</Box>
